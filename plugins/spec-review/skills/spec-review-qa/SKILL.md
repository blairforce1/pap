---
name: spec-review-qa
description: Quality assurance and testability review of a design specification. Run when the user asks for a QA review, testability assessment, or requirements-quality check of a design spec. Reviews designs only, never code or test code. For code, use a code-review-* skill.
disallowed-tools:
  - Agent
  - Artifact
  - AskUserQuestion
...
2. **Findings table**: columns ID (QA-001...), Severity, Spec section, Finding, Recommendation.
