...
| `plugins/spec-review/` | A Claude Code plugin for phase 3, spec review: twelve reviewer perspectives, from security to Solvency II, plus `spec-review-full` to run the whole board. Works on any design document, with or without the `pap` plugin. |
